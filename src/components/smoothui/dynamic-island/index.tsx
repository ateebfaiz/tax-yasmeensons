  ...
  return (
    <div className={`h-[200px] ${className}`}>
      <div className="relative flex h-full w-full flex-col justify-center">
        ...
        <div className="absolute bottom-2 left-1/2 z-10 flex -translate-x-1/2 justify-center gap-1 rounded-full border border-oklch(0.922 0 0) bg-oklch(1 0 0) p-1 dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.145 0 0)">
          {[
            ...
            <button
              aria-label={key}
              className="flex size-8 cursor-pointer items-center justify-center rounded-full border border-oklch(0.922 0 0) bg-oklch(0.205 0 0) px-2 dark:border-oklch(1 0 0 / 10%) dark:bg-oklch(0.922 0 0)"
              key={key}
              onClick={() => {
                if (view !== key) {
