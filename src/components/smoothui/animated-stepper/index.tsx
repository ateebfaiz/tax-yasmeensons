  ...
  return (
    ...
    >
      ...
      >
          ...
          return (
            ...
            >
              <motion.button
                ...
                className={cn(
                  ...
                  !(isActive || isCompleted) &&
                    "border-oklch(0.556 0 0)/30 bg-oklch(1 0 0) text-oklch(0.556 0 0) dark:border-oklch(0.708 0 0)/30 dark:bg-oklch(0.145 0 0) dark:text-oklch(0.708 0 0)",
              ...
              >
                ...
                {isActive && !shouldReduceMotion && (
                  <motion.span
                    ...
                    className="absolute inset-0 rounded-full border-2 border-oklch(0.205 0 0) dark:border-oklch(0.922 0 0)"
                ...
                <div className="ml-2 hidden sm:block">
                  <p
                    className={cn(
                      ...
                      isActive ? "text-oklch(0.145 0 0) dark:text-oklch(0.985 0 0)" : "text-oklch(0.556 0 0) dark:text-oklch(0.708 0 0)"
                    )}
                  >
                    {step.label}
                  </p>
                  {step.description ? (
                    <p className="text-oklch(0.556 0 0) text-xs dark:text-oklch(0.708 0 0)">
                      {step.description}
                    </p>
                  ) : null}
                </div>
              ...
              {isHorizontal && index < steps.length - 1 && (
                <div className="mx-2 h-0.5 flex-1 overflow-hidden rounded-full bg-oklch(0.97 0 0) dark:bg-oklch(0.269 0 0)">
                  <motion.div
                    animate={{ width: index < activeStep ? "100%" : "0%" }}
                    className="h-full bg-oklch(0.205 0 0) dark:bg-oklch(0.922 0 0)"
                    transition={shouldReduceMotion ? { duration: 0 } : SPRING}
                  />
                </div>
              )}
        ...
        {!isHorizontal && (
          <div className="absolute top-5 left-5 h-[calc(100%-2.5rem)] w-0.5 -translate-x-1/2 overflow-hidden bg-oklch(0.97 0 0) dark:bg-oklch(0.269 0 0)">
            <motion.div
              animate={{ height: `${progress * 100}%` }}
              className="w-full bg-oklch(0.205 0 0) dark:bg-oklch(0.922 0 0)"
              transition={shouldReduceMotion ? { duration: 0 } : SPRING}
            />
          </div>
        )}
