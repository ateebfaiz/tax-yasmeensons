  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16 space-y-8">
      ...
      <div className="text-center space-y-3">
        <span className="font-mono text-xs text-apple-blue font-bold uppercase tracking-widest bg-apple-blue/10 border border-apple-blue/30 px-3.5 py-1 rounded-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/[0.04] dark:bg-white/[0.08] border border-black/[0.10] dark:border-white/[0.15] text-ink dark:text-white rounded-xl px-3.5 py-2.5 text-xs font-mono placeholder:text-ash/50 dark:placeholder:text-white/40 focus:border-apple-blue focus:ring-2 focus:ring-apple-blue/20 outline-none uppercase"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-black/[0.04] dark:bg-white/[0.08] border border-black/[0.10] dark:border-white/[0.15] text-ink dark:text-white rounded-xl px-3.5 py-2.5 text-xs font-mono placeholder:text-ash/50 dark:placeholder:text-white/40 focus:border-apple-blue focus:ring-2 focus:ring-apple-blue/20 outline-none"
              />
            </div>
          </div>
      ...
      {caseData && (
        <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-300">
          <GlassCard variant="glow" className="p-6 space-y-4 border-apple-blue/50">
