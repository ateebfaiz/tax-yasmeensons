  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16 space-y-8">
      ...
      <div className="text-center space-y-3">
        <span className="font-mono text-xs text-[#20b6a5] font-bold uppercase tracking-widest bg-[#20b6a5]/10 border border-[#20b6a5]/30 px-3.5 py-1 rounded-full">
          CASE PROGRESS TRACKER · TY2026
        </span>
        <h1 className="font-serif text-3xl sm:text-4xl font-black text-ink dark:text-white tracking-tight">
          Track Your Tax Filing Case
        </h1>
        <p className="text-xs sm:text-sm text-ash max-w-lg mx-auto leading-relaxed">
          Enter your Reference Number (<code className="font-mono text-ink dark:text-white">YS-26-XXXXX</code>) and optional CNIC to view live verification, audit, and ATL filing status.
        </p>
      </div>
      ...
      <GlassCard variant="default" className="p-5 sm:p-7 max-w-2xl mx-auto space-y-4 shadow-md">
        <form onSubmit={handleLookup} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label className="block text-xs font-bold text-ink dark:text-white mb-1 font-mono">
              ...
              <input
                ...
                className="w-full bg-[rgba(15,22,27,0.7)] border border-white/[0.14] rounded-xl px-3.5 py-2.5 text-xs font-mono text-white placeholder-white/30 focus:border-[#20b6a5] outline-none uppercase"
              />
            </div>
        ...
        <div className="pt-2 flex items-center justify-between text-[11px] text-ash border-t border-white/[0.08]">
          <span className="flex items-center gap-1">
            <ShieldCheck className="w-3.5 h-3.5 text-[#20b6a5]" />
          ...
          <a
            ...
            className="text-[#20b6a5] hover:underline"
          >
            Lost Reference?
          </a>
        </div>
      ...
      {caseData && (
        <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-300">
          <GlassCard variant="glow" className="p-6 space-y-4 border-[#20b6a5]/50">
            <div className="flex flex-wrap items-start justify-between gap-3 border-b border-white/[0.08] pb-3">
              <div>
                <span className="font-mono text-[11px] text-[#20b6a5] font-bold uppercase tracking-wider">
              ...
              <div className="text-right">
                <span className="inline-block px-3 py-1 rounded-full text-xs font-mono font-bold bg-[#20b6a5]/20 text-[#20b6a5] border border-[#20b6a5]/40 uppercase">
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 rounded-2xl border transition-all ${
                        isCurrent
                          ? "bg-[rgba(32,182,165,0.18)] border-[#20b6a5] shadow-[0_0_12px_rgba(32,182,165,0.25)] text-white"
                          : isDone
                    ...
                    >
                      <div className="flex items-center justify-between text-xs font-mono mb-1">
                        ...
                        {isDone ? (
                          <CheckCircle2 className="w-3.5 h-3.5 text-[#20b6a5]" />
                        ) : (
